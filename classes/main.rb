...
def route_actions
  ...
  when 1
    ...
    @stations.each.with_index { |station, index| puts "#{index} - #{station.name}" }
    puts 'Enter number of  startstation: '
    number_of_start_station = gets.chomp.to_i
    @start_station = @stations[number_of_start_station]
    puts 'Enter number of finishstation: '
    number_of_finish_station = gets.chomp.to_i
    @finish_station = @stations[number_of_finish_station]
  ...
  when 2
    ...
    @stations.each.with_index { |station, index| puts "#{index} - #{station.name}" }
    puts 'Enter number of waystation: '
    number_of_way_station = gets.chomp.to_i
    way_station = @stations[number_of_way_station]
...
def other_train_actions
  ...
  when 4
    ...
    puts "Trains contains #{@active_train.num_of_cars} carriages"
  when 5
